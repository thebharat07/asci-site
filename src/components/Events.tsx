...
const Events = () => {
  ...
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
    ...
    },
    {
      ...
      color: "#EC4899",
      borderColor: "#DB2777",
      images: ["/events/inaug/2.jpg", "/events/inaug/3.jpg"]
    },
    {
      event_id: 3,
      event_name: "Mindware",
      ...
      color: "#A855F7",
      borderColor: "#9333EA",
      images: ["/events/inaug/1.jpg", "/events/inaug/3.jpg"]
    },
    {
      event_id: 4,
    ...
    },
    {
      ...
      images: [
        "/events/masterthecode/1.jpg",
        "/events/masterthecode/2.jpg",
        "/events/masterthecode/3.jpg"
      ],
      color: "#F97316",
      borderColor: "#EA580C",
    },
    {
      ...
      images: [
        "/events/skill_ai/1.jpg",
        "/events/skill_ai/2.jpg",
        "/events/skill_ai/3.jpg"
      ],
      color: "#6366F1",
      borderColor: "#4F46E5",
    },
    {
      ...
      images: [
        "/events/Android/img-1.jpg",
        "/events/Android/img-2.jpg",
        "/events/Android/img-3.jpg"
      ],
      color: "#10B981",
      borderColor: "#059669",
    },
    {
      ...
      images: [
        "/events/Catch_the_phish/1.jpg",
        "/events/Catch_the_phish/2.jpg",
        "/events/Catch_the_phish/3.jpg"
      ],
      color: "#0EA5E9",
      borderColor: "#0284C7",
    },
    {
      ...
      images: [
        "/events/Byte_the_Byte/1.jpg",
        "/events/Byte_the_Byte/2.jpg",
        "/events/Byte_the_Byte/3.jpg"
      ],
      color: "#14B8A6",
      borderColor: "#0D9488",
    },
    {
      ...
      images: [
        "/events/dataSprint/1.jpg",
        "/events/dataSprint/2.jpg",
        "/events/dataSprint/3.jpg"
      ],
      color: "#A855F7",
      borderColor: "#9333EA",
    },
    ...
    },
    {
      ...
      images: [
        "/events/explore_cloud/1.jpg",
        "/events/explore_cloud/2.jpg",
        "/events/explore_cloud/3.jpg"
      ],
      color: "#06B6D4",
      borderColor: "#0891B2",
    },
    {
      ...
      images: [
        "/events/decode_world/1.jpg",
        "/events/decode_world/2.jpg",
        "/events/decode_world/3.jpg"
      ],
      color: "#0EA5E9",
      borderColor: "#0284C7",
    },
                ...
                >
                  ...
                  >
                    <div className="w-full h-full flex items-center justify-center">
                      <img src={event.images[currentImageIndex]} alt={event.event_name} className="object-cover w-full h-full" />
                    </div>
                  ...
                  <div className="h-full p-6 bg-gradient-to-br from-gray-800 to-gray-900">
                    <span
