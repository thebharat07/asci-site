  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      detail: 'techclub@college.edu',
      link: 'mailto:techclub@college.edu'
    },
    {
      icon: Phone,
      title: 'Phone',
    ...
    },
    {
      icon: MapPin,
      title: 'Location',
      detail: 'Tech Building, College Campus',
      link: '#'
    }
  ];
          ...
          {contactInfo.map((info, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-blue-400 transition-colors duration-300">{info.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="bg-gradient-to-br from-blue-600 via-blue-500 to-blue-600 p-12 text-white flex flex-col justify-center">
              ...
              <p className="text-blue-100 mb-8 text-lg leading-relaxed">
                Whether you want to join our club, collaborate on a project, or just say hello,
                we're always excited to hear from fellow tech enthusiasts.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center transform hover:translate-x-2 transition-transform duration-300">
                  <div className="w-2 h-2 bg-blue-200 rounded-full mr-3"></div>
                  <span className="text-blue-100">Join our community of innovators</span>
                </div>
                <div className="flex items-center transform hover:translate-x-2 transition-transform duration-300">
                  <div className="w-2 h-2 bg-blue-200 rounded-full mr-3"></div>
                  <span className="text-blue-100">Access to exclusive events and workshops</span>
                </div>
              </div>
            </div>
