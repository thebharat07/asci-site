  ...
  const features = [
    {
      ...
      title: "Our Mission",
      description:
        "To foster innovation and technical excellence among students through hands-on learning and collaborative projects.",
    },
    {
      icon: Users,
      title: "Community",
      description:
        "Building a vibrant community of tech enthusiasts who learn, grow, and innovate together.",
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description:
        "Encouraging creative thinking and problem-solving through workshops, hackathons, and competitions.",
    },
    {
      icon: Award,
      title: "Excellence",
      description:
        "Striving for excellence in every project and event, pushing boundaries and setting new standards.",
    },
  ];
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl shadow-blue-500/30 hover:shadow-blue-400/40 transition-all duration-500 transform hover:scale-[1.02]">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="group">
              ...
              <div className="text-blue-100">Student Impressions</div>
            </div>
          </div>
        </div>
      </div>
